...
def _build_instruction(ctx) -> str:
    ...
    return (
        ...
        "-> record_skill_observation, in whichever of the five fixed categories "
        "(CAD & Mechanical Design, Electronics & Circuits, Firmware & Embedded "
        "Coding, Software & Web Development, 3D Printing & Manufacturing) it fits. "
        "Keep each statement short and specific (e.g. 'Comfortable with Arduino "
        "boards but hasn't used I2C sensors yet'), not a vague label — this is what "
